...
def answer_question(question: str, show_sources: bool = True, force_rebuild: bool = False, num_docs: Optional[int] = None) -> dict:
    """
    ...
    logger.info(f"⚡ RAG réponse générée en {total_duration:.2f}ms (retrieval: {retrieval_duration:.2f}ms, generation: {generation_duration:.2f}ms)")
...
def answer_question_stream(question: str, force_rebuild: bool = False, num_docs: Optional[int] = None, streaming_delay: Optional[float] = None):
    """
